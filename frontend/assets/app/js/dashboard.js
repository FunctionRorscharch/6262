var Dashboard = (function () {
  ...
  var d = function () {
    $('#m_chart_revenue_change').length != 0 &&
        Morris.Donut({
  ...
  var c = function () {
    $('#m_chart_support_tickets').length != 0 &&
        Morris.Donut({
  ...
  var p = function () {
    $('#m_chart_support_tickets2').length != 0 &&
        new Chartist.Pie(
    ...
    function e (e, a, r) {
      ...
      a - e < 100
        ...
        : r == 'Yesterday'
          ...
          : (l = e.format('MMM D') + ' - ' + a.format('MMM D')),
        ...
        eventRender: function (e, t) {
          t.hasClass('fc-day-grid-event')
            ...
            : t.hasClass('fc-time-grid-event')
              ...
              : t.find('.fc-list-item-title').lenght !== 0 &&
                t
